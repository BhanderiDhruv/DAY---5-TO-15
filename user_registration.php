<?php
    @$id=$_REQUEST['id'];
    $sel="SELECT * FROM `user_registration` WHERE `user_id`='".$id."'";
            ...
            <div class="span12">
                ...
                <div id="horizontal" class="widget widget-form">
                    ...
                    <div class="widget-content">
                        ...
                        <form class="form-horizontal" method="post" action="index.php?page=userreg_action" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="form-actions">
                                ...
                                <button class="btn btn-large"><a href="index.php?page=user_registration">Cancel</button></a>
                            </div>
                     </fieldset>
                </form>
            </div>
